...
public class psi04_FixedD extends Agent {
	...
	public void setup() {
		...
		System.out.println("[Def]: Hi! Im " + getLocalName() + " and Im a Fixed Defector");
		
		//We add the behaviour
		this.addBehaviour(new FixedDefectorBehaviour(this));
		...
		try {
			...
			System.out.println("[Def]: Registered!");
		} catch (FIPAException fe) {
			//We print that we were not able to register
			fe.printStackTrace();
			System.out.println("[Def]: Not registered!");
		}
	}
	...
	protected void takeDown() {
		...
		System.out.println("[Def]: terminating...");
	}
