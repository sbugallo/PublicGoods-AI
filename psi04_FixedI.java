 ...
 * as a fixed Inspector */
@SuppressWarnings("serial")
public class psi04_FixedI extends Agent {
	...
	public void setup() {
		...
		System.out.println("[Ins]: Hi! Im " + getLocalName() + " and Im a Fixed Inspector");
		
		//We add the behaviour
		this.addBehaviour(new FixedInspectorBehaviour(this));
		...
		try {
			...
			System.out.println("[Ins]: Registered!");
		} catch (FIPAException fe) {
			//We print that we were not able to register
			fe.printStackTrace();
			System.out.println("[Ins]: Not registered!");
		}
	}
	...
	protected void takeDown() {
		...
		System.out.println("[Ins]: terminating...");
	}
